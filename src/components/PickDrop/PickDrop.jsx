...
const PickDrop = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 items-center my-5 relative">
      {/* Pick Up */}
      ...
      <button className="bg-primary-500 rounded-lg w-fit p-4 absolute top-[40%] md:top-[30%] md:left-0 md:right-0 md:mx-auto z-[999]">
        <PickDropIcon />
