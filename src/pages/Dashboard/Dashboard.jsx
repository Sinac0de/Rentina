      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Welcome back, {user?.name}. Here is what is happening with your car rental business.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Published Blogs</p>
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                  {stats?.stats?.blogs || 0}
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <BarChart3 className="text-gray-500 dark:text-gray-400" size={20} />
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <Car className="text-blue-600 dark:text-blue-400 mb-2" size={24} />
            ...
            <button
              ...
              className="flex flex-col items-center justify-center p-6 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
            >
              <BookOpen className="text-purple-600 dark:text-purple-400 mb-2" size={24} />
              <span className="text-sm font-medium text-gray-900 dark:text-white">
                Manage Blogs
              </span>
            </button>
